...
router.post('/', auth.requireAuth, validate.createOrder, orderController.createOrder);
...
router.put('/:orderId/status', auth.requireAuth, auth.requireRole('admin', 'seller'), validate.updateOrderStatus, orderController.updateOrderStatus); 
...
// Payment processing
router.post('/:orderId/payment', auth.requireAuth, validate.addOrderPayment, orderController.processPayment);
